...
function TServerMethods1(connectionInfo)
{
   ...
   */
  this.LisarAlunos = function(Codigo) {
    var returnObject = this.executor.executeMethod('LisarAlunos', "GET", [Codigo], arguments[1], true, arguments[2], arguments[3]);
    if (arguments[1] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.LisarAlunos_URL = function(Codigo) {
    return this.executor.getMethodURL("LisarAlunos", "GET", [Codigo], arguments[1])[0];
  };
}
...
var JSProxyClassList = {
  ...
  "TServerMethods1": ["EchoString","ReverseString","LisarAlunos"]
};
