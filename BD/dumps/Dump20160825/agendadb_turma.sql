...
INSERT INTO `turma` VALUES (8,'Sala 1','sss',3,1,16,'2016-08-22 12:39:48'),(9,'Sala 2','fdasda',4,1,11,NULL),(14,'Turma de Teste - ID Escola 2 s',NULL,3,2,9,'2016-04-19 15:07:58'),(18,'Todos Alunos',NULL,6,1,11,'2016-08-23 11:12:25'),(19,'Sala 3',NULL,6,1,16,NULL),(22,'Sala 4',NULL,3,1,6,NULL),(28,'Sala 5','sss',3,1,6,'2016-04-24 13:23:22');
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`admin`@`%`*/ /*!50003 TRIGGER `agendadb`.`turma_BEFORE_INSERT` BEFORE INSERT ON `turma` FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`admin`@`%`*/ /*!50003 TRIGGER `agendadb`.`turma_BEFORE_UPDATE` BEFORE UPDATE ON `turma` FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`admin`@`%`*/ /*!50003 TRIGGER `agendadb`.`turma_BEFORE_DELETE` BEFORE DELETE ON `turma` FOR EACH ROW
BEGIN
...
-- Dump completed on 2016-08-25 15:50:14
