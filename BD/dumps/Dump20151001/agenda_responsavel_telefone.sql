...
CREATE TABLE `responsavel_telefone` (
  ...
  CONSTRAINT `fk_responsavel_telefone_x_responsavel` FOREIGN KEY (`responsavel_id`) REFERENCES `responsavel` (`responsavel_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- Dump completed on 2015-10-01 15:05:30
