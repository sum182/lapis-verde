...
CREATE TABLE `escola_endereco` (
  ...
  CONSTRAINT `fk_escola_endereco_x_escola` FOREIGN KEY (`escola_id`) REFERENCES `escola` (`escola_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `escola_endereco` VALUES (1,'07020240','teste',222,'22','ds','d','SC',3),(2,'07020240',NULL,23342,NULL,NULL,NULL,NULL,5);
...
-- Dump completed on 2015-11-10  7:41:46
