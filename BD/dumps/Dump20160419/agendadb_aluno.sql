...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`admin`@`%`*/ /*!50003 TRIGGER `agendadb`.`aluno_AFTER_INSERT` AFTER INSERT ON `aluno` FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`admin`@`%`*/ /*!50003 TRIGGER `agendadb`.`trg_aluno_AFTER_UPDATE` AFTER UPDATE ON `aluno` FOR EACH ROW
BEGIN
   CALL  sp_tabela_atualizacao_set('aluno',new.escola_id);
END */;;
DELIMITER ;
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`admin`@`%`*/ /*!50003 TRIGGER `agendadb`.`aluno_AFTER_DELETE` AFTER DELETE ON `aluno` FOR EACH ROW
BEGIN
...
-- Dump completed on 2016-04-19  1:12:20
