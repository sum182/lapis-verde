...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`admin`@`%`*/ /*!50003 TRIGGER `dbdev`.`responsavel_AFTER_INSERT` AFTER INSERT ON `responsavel` FOR EACH ROW
BEGIN
  CALL sp_tabela_atualizacao_set_by_user('responsavel',new.responsavel_id,null);
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
