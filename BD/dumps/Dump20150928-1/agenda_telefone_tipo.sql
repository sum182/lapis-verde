...
CREATE TABLE `telefone_tipo` (
  `telefone_tipo_id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `telefone_tipo` VALUES (1,'Comercial',NULL),(2,'Celular',NULL),(3,'Residencial',NULL);
...
-- Dump completed on 2015-09-28 12:50:12
