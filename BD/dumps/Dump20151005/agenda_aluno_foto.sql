...
CREATE TABLE `aluno_foto` (
  ...
  CONSTRAINT `fk_aluno_foto_x_aluno` FOREIGN KEY (`aluno_id`) REFERENCES `aluno` (`aluno_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2015-10-05 12:29:28
