...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`admin`@`%`*/ /*!50003 TRIGGER `dbdev`.`telefone_tipo_BEFORE_INSERT` BEFORE INSERT ON `telefone_tipo` FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`admin`@`%`*/ /*!50003 TRIGGER `dbdev`.`telefone_tipo_BEFORE_UPDATE` BEFORE UPDATE ON `telefone_tipo` FOR EACH ROW
BEGIN
CALL  sp_tabela_atualizacao_set('telefone_tipo',null);
END */;;
DELIMITER ;
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`admin`@`%`*/ /*!50003 TRIGGER `dbdev`.`telefone_tipo_BEFORE_DELETE` BEFORE DELETE ON `telefone_tipo` FOR EACH ROW
BEGIN
CALL  sp_tabela_atualizacao_set('telefone_tipo',null);
END */;;
DELIMITER ;
...
-- Dump completed on 2016-11-25 15:53:19
