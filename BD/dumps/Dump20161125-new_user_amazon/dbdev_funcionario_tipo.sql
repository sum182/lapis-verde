...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`admin`@`%`*/ /*!50003 TRIGGER `dbdev`.`funcionario_tipo_BEFORE_INSERT` BEFORE INSERT ON `funcionario_tipo` FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`admin`@`%`*/ /*!50003 TRIGGER `dbdev`.`funcionario_tipo_BEFORE_UPDATE` BEFORE UPDATE ON `funcionario_tipo` FOR EACH ROW
BEGIN
  CALL  sp_tabela_atualizacao_set('funcionario_tipo',null);
END */;;
DELIMITER ;
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`admin`@`%`*/ /*!50003 TRIGGER `dbdev`.`funcionario_tipo_BEFORE_DELETE` BEFORE DELETE ON `funcionario_tipo` FOR EACH ROW
BEGIN
  CALL  sp_tabela_atualizacao_set('funcionario_tipo',null);
END */;;
DELIMITER ;
...
-- Dump completed on 2016-11-25 15:53:06
