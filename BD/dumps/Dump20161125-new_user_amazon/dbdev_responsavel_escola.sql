...
--
-- Dumping data for table `responsavel_escola`
--

LOCK TABLES `responsavel_escola` WRITE;
/*!40000 ALTER TABLE `responsavel_escola` DISABLE KEYS */;
INSERT INTO `responsavel_escola` VALUES (9,1,'S','sss',1),(10,1,'S',NULL,NULL),(16,2,'S',NULL,NULL),(75,1,'S',NULL,1);
/*!40000 ALTER TABLE `responsavel_escola` ENABLE KEYS */;
UNLOCK TABLES;
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`admin`@`%`*/ /*!50003 TRIGGER `dbdev`.`responsavel_escola_BEFORE_INSERT` BEFORE INSERT ON `responsavel_escola` FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`admin`@`%`*/ /*!50003 TRIGGER `dbdev`.`responsavel_escola_BEFORE_UPDATE` BEFORE UPDATE ON `responsavel_escola` FOR EACH ROW
BEGIN
  call sp_set_time_zone;
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`admin`@`%`*/ /*!50003 TRIGGER `dbdev`.`responsavel_escola_BEFORE_DELETE` BEFORE DELETE ON `responsavel_escola` FOR EACH ROW
BEGIN
...
-- Dump completed on 2016-11-25 15:53:28
