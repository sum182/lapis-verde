...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`admin`@`%`*/ /*!50003 TRIGGER `dbdev`.`aluno_BEFORE_INSERT` BEFORE INSERT ON `aluno` FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`admin`@`%`*/ /*!50003 TRIGGER `dbdev`.`aluno_BEFORE_UPDATE` BEFORE UPDATE ON `aluno` FOR EACH ROW
BEGIN
if (new.data_atualizacao is null) or (new.data_atualizacao = '0000-00-00 00:00:00')then
    SET new.data_atualizacao = now();
  end if;
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`admin`@`%`*/ /*!50003 TRIGGER `dbdev`.`aluno_BEFORE_DELETE` BEFORE DELETE ON `aluno` FOR EACH ROW
BEGIN
...
-- Dump completed on 2016-11-25 15:53:07
