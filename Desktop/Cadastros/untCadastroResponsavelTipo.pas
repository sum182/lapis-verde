unit untCadastroResponsavelTipo;
...
type
  TfrmCadastroResponsavelTipo = class(TfrmCadFD)
    Label3: TLabel;
...
var
  frmCadastroResponsavelTipo: TfrmCadastroResponsavelTipo;
...
procedure TfrmCadastroResponsavelTipo.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  inherited;
  frmCadastroResponsavelTipo:= nil;
end;
