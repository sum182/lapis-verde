unit untCadastroFuncionarioTipo;
...
uses
  ...
  dxSkinVS2010, dxSkinWhiteprint, dxSkinXmas2008Blue, cxMemo, cxDBEdit, cxTextEdit;

type
  TfrmCadastroFuncionarioTipo = class(TfrmCadFD)
    Label3: TLabel;
...
var
  frmCadastroFuncionarioTipo: TfrmCadastroFuncionarioTipo;
...
procedure TfrmCadastroFuncionarioTipo.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  inherited;
  frmCadastroFuncionarioTipo:=nil;
end;
